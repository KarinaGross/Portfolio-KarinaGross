...
// • Используя JavaScript и ваш API-ключ, получить случайное изображение из Unsplash каждый раз,
//   когда пользователь загружает страницу.
// • Отобразить информацию о фотографе под изображением.
// • Реализовать функционал "лайка". Каждый раз, когда пользователь нажимает кнопку "лайк", счетчик
